const CACHE_NAME = 'qudah-consulting-labs-v1';
const urlsToCache = [
  '/QCL/',
  '/QCL/index.html',
      ...
      .then((response) => {
        ...
        return fetch(fetchRequest).then((response) => {
          ...
          if (event.request.destination === 'document') {
            return caches.match('/QCL/index.html');
          }
        });
      })
  );
...
self.addEventListener('push', (event) => {
  const options = {
    ...
    badge: '/QCL/icons/icon-72x72.png',
    vibrate: [100, 50, 100],
    data: {
